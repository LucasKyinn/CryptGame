...
void UMover::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
	...
	if (ShouldMove) {
		...
		float Speed = FVector::Distance(InitialLocation, TargetLocation) / MoveTime;
		...
		float Speed = FVector::Distance(GetOwner()->GetActorLocation(), TargetLocation) / MoveTime;
...
void UMover::SetShouldMove(bool NewBool)
{
	ShouldMove = NewBool;
}
